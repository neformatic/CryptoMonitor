...
namespace CryptoMonitor.DAL.Migrations
{
    ...
    [Migration("20220227100429_AddModelsToEntities")]
    partial class AddModelsToEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoMonitor.DAL.Entities.Account", b =>
                {
                    ...
                    b.Property<int>("AccountPassword")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CryptoMonitor.DAL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CryptoMonitor.DAL.Entities.Account", b =>
                {
                    b.HasOne("CryptoMonitor.DAL.Entities.Role", "Role")
                        .WithMany()
